...
public class MediumGamePlay extends JFrame implements MouseMotionListener, MouseListener {//, KeyListener {
  ...
  static Animator anim;
    ...
    public static void main(String[] args) {
      ...
      MediumGamePlay app = new MediumGamePlay();
        
    }

    public MediumGamePlay() {
        super("Air_Hocky");
